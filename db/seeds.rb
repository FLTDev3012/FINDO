...
GiftsTag.new(gift_id: bougie.id, tag_id: adulte.id)
GiftsTag.new(gift_id: bougie.id, tag_id: made.id)
GiftsTag.new(gift_id: bougie.id, tag_id: life.id)
...
GiftsTag.new(gift_id: montre.id,  tag_id: anniv.id)
GiftsTag.new(gift_id: montre.id,  tag_id: adulte.id)
GiftsTag.new(gift_id: montre.id,  tag_id: ado.id)
GiftsTag.new(gift_id: montre.id,  tag_id: life.id)
GiftsTag.new(gift_id: montre.id,  tag_id: ht.id)
GiftsTag.new(gift_id: montre.id, tag_id: quatre.id)
GiftsTag.new(gift_id: montre.id, tag_id: six.id)
...
GiftsTag.new(gift_id: cle.id, tag_id: noel.id)
GiftsTag.new(gift_id: cle.id, tag_id: adulte.id)
GiftsTag.new(gift_id: cle.id, tag_id: ado.id)
GiftsTag.new(gift_id: cle.id, tag_id: deco.id)
GiftsTag.new(gift_id: cle.id, tag_id: life.id)
GiftsTag.new(gift_id: cle.id, tag_id: arti.id)
GiftsTag.new(gift_id: cle.id, tag_id: deux.id)
GiftsTag.new(gift_id: cle.id, tag_id: six.id)
...
GiftsTag.new(gift_id: hat.id,  tag_id: anniv.id)
GiftsTag.new(gift_id: hat.id,  tag_id: noel.id)
GiftsTag.new(gift_id: hat.id,  tag_id: adulte.id)
GiftsTag.new(gift_id: hat.id,  tag_id: ado.id)
GiftsTag.new(gift_id: hat.id,  tag_id: life.id)
GiftsTag.new(gift_id: hat.id, tag_id: trois.id)
GiftsTag.new(gift_id: hat.id, tag_id: six.id)
...
GiftsTag.new(gift_id: fruit.id,  tag_id: anniv.id)
GiftsTag.new(gift_id: fruit.id,  tag_id: noel.id)
GiftsTag.new(gift_id: fruit.id,  tag_id: adulte.id)
GiftsTag.new(gift_id: fruit.id,  tag_id: ado.id)
GiftsTag.new(gift_id: fruit.id,  tag_id: enfant.id)
GiftsTag.new(gift_id: fruit.id,  tag_id: deco.id)
GiftsTag.new(gift_id: fruit.id,  tag_id: life.id)
GiftsTag.new(gift_id: fruit.id, tag_id: deux.id)
GiftsTag.new(gift_id: fruit.id, tag_id: six.id)
...
GiftsTag.new(gift_id: neon.id, tag_id: anniv.id)
GiftsTag.new(gift_id: neon.id, tag_id: noel.id)
GiftsTag.new(gift_id: neon.id, tag_id: petit.id)
GiftsTag.new(gift_id: neon.id, tag_id: adulte.id)
GiftsTag.new(gift_id: neon.id, tag_id: enfant.id)
GiftsTag.new(gift_id: neon.id, tag_id: ado.id)
GiftsTag.new(gift_id: neon.id, tag_id: bebe.id)
GiftsTag.new(gift_id: neon.id, tag_id: deco.id)
GiftsTag.new(gift_id: neon.id, tag_id: life.id)
GiftsTag.new(gift_id: neon.id, tag_id: arti.id)
GiftsTag.new(gift_id: neon.id, tag_id: ht.id)
GiftsTag.new(gift_id: neon.id, tag_id: un.id)
GiftsTag.new(gift_id: neon.id, tag_id: six.id)
...
GiftsTag.new(gift_id: hochet.id tag_id: naiss.id)
GiftsTag.new(gift_id: hochet.id tag_id: noel.id)
GiftsTag.new(gift_id: hochet.id tag_id: petit.id)
GiftsTag.new(gift_id: hochet.id tag_id: bebe.id)
GiftsTag.new(gift_id: hochet.id tag_id: deco.id)
GiftsTag.new(gift_id: hochet.id tag_id: arti.id)
GiftsTag.new(gift_id: hochet.id tag_id: made.id)
GiftsTag.new(gift_id: hochet.id, tag_id: un.id)
GiftsTag.new(gift_id: hochet.id, tag_id: six.id)
...
GiftsTag.new(gift_id: kit.id tag_id: anniv.id)
GiftsTag.new(gift_id: kit.id tag_id: noel.id)
GiftsTag.new(gift_id: kit.id tag_id: petit.id)
GiftsTag.new(gift_id: kit.id tag_id: adulte.id)
GiftsTag.new(gift_id: kit.id tag_id: ado.id)
GiftsTag.new(gift_id: kit.id tag_id: deco.id)
GiftsTag.new(gift_id: kit.id tag_id: diy.id)
GiftsTag.new(gift_id: kit.id, tag_id: un.id)
GiftsTag.new(gift_id: kit.id, tag_id: six.id)
...
GiftsTag.new(gift_id: affiche.id tag_id: anniv.id)
GiftsTag.new(gift_id: affiche.id tag_id: noel.id)
GiftsTag.new(gift_id: affiche.id tag_id: naiss.id)
GiftsTag.new(gift_id: affiche.id tag_id: bebe.id)
GiftsTag.new(gift_id: affiche.id tag_id: deco.id)
GiftsTag.new(gift_id: affiche.id tag_id: arti.id)
GiftsTag.new(gift_id: affiche.id tag_id: petit.id)
GiftsTag.new(gift_id: affiche.id, tag_id: un.id)
GiftsTag.new(gift_id: affiche.id, tag_id: six.id)
...
GiftsTag.new(gift_id: trousse.id tag_id: adulte.id)
GiftsTag.new(gift_id: trousse.id tag_id: ado.id)
GiftsTag.new(gift_id: trousse.id tag_id: anniv.id)
GiftsTag.new(gift_id: trousse.id tag_id: noel.id)
GiftsTag.new(gift_id: trousse.id tag_id: life.id)
GiftsTag.new(gift_id: trousse.id tag_id: arti.id)
GiftsTag.new(gift_id: trousse.id, tag_id: deux.id)
GiftsTag.new(gift_id: trousse.id, tag_id: six.id)
...
GiftsTag.new(gift_id: jeu.id tag_id: anniv.id)
GiftsTag.new(gift_id: jeu.id tag_id: noel.id)
GiftsTag.new(gift_id: jeu.id tag_id: naiss.id)
GiftsTag.new(gift_id: jeu.id tag_id: bebe.id)
GiftsTag.new(gift_id: jeu.id tag_id: deco.id)
GiftsTag.new(gift_id: jeu.id tag_id: arti.id)
GiftsTag.new(gift_id: jeu.id tag_id: petit.id)
GiftsTag.new(gift_id: jeu.id, tag_id: un.id)
GiftsTag.new(gift_id: jeu.id, tag_id: trois.id)
GiftsTag.new(gift_id: jeu.id, tag_id: six.id)
...
GiftsTag.new(gift_id: poster.id  tag_id: anniv.id)
GiftsTag.new(gift_id: poster.id  tag_id: noel.id)
GiftsTag.new(gift_id: poster.id  tag_id: adulte.id)
GiftsTag.new(gift_id: poster.id  tag_id: ado.id)
GiftsTag.new(gift_id: poster.id  tag_id: enfant.id)
GiftsTag.new(gift_id: poster.id  tag_id: deco.id)
GiftsTag.new(gift_id: poster.id  tag_id: life.id)
GiftsTag.new(gift_id: poster.id  tag_id: made.id)
GiftsTag.new(gift_id: poster.id, tag_id: un.id)
GiftsTag.new(gift_id: poster.id, tag_id: six.id)
...
GiftsTag.new(gift_id: bracelet.id  tag_id: anniv.id)
GiftsTag.new(gift_id: bracelet.id  tag_id: noel.id)
GiftsTag.new(gift_id: bracelet.id  tag_id: adulte.id)
GiftsTag.new(gift_id: bracelet.id  tag_id: ado.id)
GiftsTag.new(gift_id: bracelet.id  tag_id: petit.id)
GiftsTag.new(gift_id: bracelet.id  tag_id: life.id)
GiftsTag.new(gift_id: bracelet.id  tag_id: made.id)
GiftsTag.new(gift_id: bracelet.id, tag_id: un.id)
GiftsTag.new(gift_id: bracelet.id, tag_id: six.id)
...
GiftsTag.new(gift_id: bague.id  tag_id: anniv.id)
GiftsTag.new(gift_id: bague.id  tag_id: noel.id)
GiftsTag.new(gift_id: bague.id  tag_id: adulte.id)
GiftsTag.new(gift_id: bague.id  tag_id: ado.id)
GiftsTag.new(gift_id: bague.id  tag_id: petit.id)
GiftsTag.new(gift_id: bague.id  tag_id: life.id)
GiftsTag.new(gift_id: bague.id  tag_id: made.id)
GiftsTag.new(gift_id: bague.id, tag_id: un.id)
GiftsTag.new(gift_id: bague.id, tag_id: six.id)
...
GiftsTag.new(gift_id: vase.id  tag_id: anniv.id)
GiftsTag.new(gift_id: vase.id  tag_id: noel.id)
GiftsTag.new(gift_id: vase.id  tag_id: adulte.id)
GiftsTag.new(gift_id: vase.id  tag_id: ado.id)
GiftsTag.new(gift_id: vase.id  tag_id: deco.id)
GiftsTag.new(gift_id: vase.id  tag_id: life.id)
GiftsTag.new(gift_id: vase.id, tag_id: un.id)
GiftsTag.new(gift_id: vase.id, tag_id: six.id)
...
GiftsTag.new(gift_id: fleur.id  tag_id: anniv.id)
GiftsTag.new(gift_id: fleur.id  tag_id: noel.id)
GiftsTag.new(gift_id: fleur.id  tag_id: adulte.id)
GiftsTag.new(gift_id: fleur.id  tag_id: ado.id)
GiftsTag.new(gift_id: fleur.id  tag_id: deco.id)
GiftsTag.new(gift_id: fleur.id  tag_id: life.id)
GiftsTag.new(gift_id: fleur.id, tag_id: un.id)
GiftsTag.new(gift_id: fleur.id, tag_id: six.id)
...
GiftsTag.new(gift_id: terra.id  tag_id: anniv.id)
GiftsTag.new(gift_id: terra.id  tag_id: noel.id)
GiftsTag.new(gift_id: terra.id  tag_id: adulte.id)
GiftsTag.new(gift_id: terra.id  tag_id: ado.id)
GiftsTag.new(gift_id: terra.id  tag_id: deco.id)
GiftsTag.new(gift_id: terra.id  tag_id: life.id)
GiftsTag.new(gift_id: terra.id  tag_id: diy.id)
GiftsTag.new(gift_id: terra.id, tag_id: un.id)
GiftsTag.new(gift_id: terra.id, tag_id: six.id)
...
GiftsTag.new(gift_id: matisse.id  tag_id: anniv.id)
GiftsTag.new(gift_id: matisse.id  tag_id: noel.id)
GiftsTag.new(gift_id: matisse.id  tag_id: adulte.id)
GiftsTag.new(gift_id: matisse.id  tag_id: ado.id)
GiftsTag.new(gift_id: matisse.id  tag_id: deco.id)
GiftsTag.new(gift_id: matisse.id  tag_id: life.id)
GiftsTag.new(gift_id: matisse.id, tag_id: un.id)
GiftsTag.new(gift_id: matisse.id, tag_id: six.id)
...
GiftsTag.new(gift_id: trousse.id tag_id: adulte.id)
GiftsTag.new(gift_id: affiche.id tag_id: ado.id)
GiftsTag.new(gift_id: affiche.id tag_id: anniv.id)
GiftsTag.new(gift_id: affiche.id tag_id: noel.id)
GiftsTag.new(gift_id: affiche.id tag_id: life.id)
GiftsTag.new(gift_id: affiche.id tag_id: arti.id)
GiftsTag.new(gift_id: affiche.id, tag_id: deux.id)
GiftsTag.new(gift_id: affiche.id, tag_id: six.id)
...
GiftsTag.new(gift_id: bag.id tag_id: adulte.id)
GiftsTag.new(gift_id: bag.id tag_id: ado.id)
GiftsTag.new(gift_id: bag.id tag_id: anniv.id)
GiftsTag.new(gift_id: bag.id tag_id: noel.id)
GiftsTag.new(gift_id: bag.id tag_id: life.id)
GiftsTag.new(gift_id: bag.id tag_id: arti.id)
GiftsTag.new(gift_id: bag.id, tag_id: deux.id)
GiftsTag.new(gift_id: bag.id, tag_id: six.id)
